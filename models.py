...
def CNN_BNN_CTC(kernel_size, num_conv1, num_conv2, num_conv3, num_conv4, num_conv5, num_rnn, num_fc, HEIGHT, WIDTH, num_classes):
    ...
    with graph.as_default():
        ...
        # Longitud de la secuencia de entrada: Tensor [tamaño de bacth]
        ...
        # optimizer = tf.train.MomentumOptimizer(learning_rate=0.1, momentum=0.9).minimize(cost)
